...
int main()
{
    ...
    cout<<"The area, perimeter and the diagonal of the first rectangle are as follows:"<<endl;
    cout<<r1.area()<<endl<<r1.perimeter()<<endl<<r1.diagonal()<<endl;
    cout<<"The area, perimeter and the diagonal of the second rectangle are as follows:"<<endl;
